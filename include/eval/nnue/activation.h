...
namespace eval::nnue::activation {
template <typename T>
concept Activation = requires(T t) {
  ...
  { T::output(typename T::OutputType{}) } -> std::same_as<typename T::OutputType>;
};
...
struct [[maybe_unused]] Identity {
  ...
  static inline auto output(OutputType value) { return value; }
};
...
struct [[maybe_unused]] SquaredClippedReLU {
  ...
  static inline auto output(OutputType value) { return value / static_cast<OutputType>(Max); }
};
}  // namespace eval::nnue::activation
